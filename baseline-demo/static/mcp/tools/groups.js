...
export const registerGroupTools = (server) => {
    server.registerTool("get_feature_groups", {
    ...
    server.registerTool("get_features_by_group", {
        description: 'Gets all web features in a specific group, such as "css" or "javascript". This is useful for exploring features within a certain technology. Input should be the group name as a string.',
        inputSchema: {
            groupName: z.string(),
        },
    }, async ({ groupName }) => {
