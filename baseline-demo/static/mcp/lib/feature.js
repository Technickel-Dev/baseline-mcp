...
export const findFeaturesInContent = (content, fileType = undefined) => {
    const foundFeatures = {};
    ...
    for (const featureId in features) {
        ...
        const description = ("description" in feature ? feature.description : "").toLowerCase();
        ...
        if (fileType === "html" || !fileType) {
            if ("group" in feature &&
                ...
                if (lowerContent.includes(`<${tagName}`) ||
        ...
        if ((fileType === "javascript" || !fileType) &&
