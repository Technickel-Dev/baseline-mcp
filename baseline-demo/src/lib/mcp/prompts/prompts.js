...
export const registerPrompts = (server) => {
    server.registerPrompt("create-study-guide", {
    ...
    server.registerPrompt("find-features-in-file", {
    ...
    server.registerPrompt("suggest-baseline-features", {
    ...
    server.registerPrompt("min-browser-support-report", {
        title: "Minimum Browser Support Report",
        description: "Get the minimum browser support for features in a set of files and display it as a report.",
        argsSchema: {
            filePath: z
                .string()
...
export const findFeaturesInFilePrompt = (filePath) => `Read the file or files in the directory at the path "${filePath}" and find the baseline features in them. Print out a full list of the feature names found to the console as a string, no markdown.`;
export const suggestBaselineFeaturePrompt = (goal) => `Suggest one or more baseline features for the following goal: "${goal}"`;
export const minBrowserSupportReportPrompt = (filePath) => `Get the minimum browser support for the features of the file or files in the directory "${filePath}". Output the results as an easy to read read report with reasoning and a minumum support table in a markdown file`;
